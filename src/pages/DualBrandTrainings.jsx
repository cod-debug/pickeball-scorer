...
export default function DualBrandTrainings() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([coursesData, pageDataFetched]) => {
        ...
        role = loaderData.dualBrandRegionData[region][brand_id]["departments"][role_id];
  ...
  return (
    <>
      <NavBar backLink={"/dual-brands/departments"} backText={translationData[pageData.back] || pageData.back} />
